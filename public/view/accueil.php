    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="card carousel-inner">
        <div class="carousel-item active">
          ...
          <form action="/Projet-Plante-connectee/public/plante.php" method="post" class="form-inline">
            <input type="hidden" id="id" name="id" value= <?php echo $array["id"]?> />
            <input style="width:180px; margin-right:0%; margin-left:40%; margin-top:15px;" class="btn btn-primary" type="submit" name="ok" value="Ma plante"  />
          </form>
        </div>
